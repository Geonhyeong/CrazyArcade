...
const ::_pbi::DescriptorTable descriptor_table_Protocol_2eproto = {
    false, false, 1515, descriptor_table_protodef_Protocol_2eproto,
    "Protocol.proto",
